...
d:/Program_Files/MounRiver/MounRiver_Studio/toolchain/OpenOCD/bin/openocd.exe -f d:/Program_Files/MounRiver/MounRiver_Studio/toolchain/OpenOCD/bin/wch-riscv.cfg \
    -c init -c halt \
